    ...
    <div class="sb-lightbox sb-direct-message-box">
        ...
        <div class="sb-main sb-scroll-area">
            ...
            <div class="sb-bottom">
                ...
                <div></div>
                <a class="sb-btn-text" target="_blank" href="<?php echo sb_is_cloud() && defined('SB_CLOUD_DOCS') ? SB_CLOUD_DOCS : 'https://board.support/docs'; ?>#direct-message">
                    <i class="sb-icon-help"></i>
                </a>
            </div>
        </div>
                        ...
                        <div class="sb-tab">
                            <div class="sb-nav">
                                ...
                                <ul>
                                    ...
                                    <li id="livesmart-dashboard">
                                        <?php echo $disable_translations ? 'LiveSmart Dashboard' : sb_('LiveSmart Dashboard') ?>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="sb-livesmart sb-tab">
                                        <div class="sb-content">
                                            ...
                                            if (isset($livesmart) && isset($livesmart['livesmart_url'])) {
                                                ...
                                                if ($active_user) {
                                                ?>
                                                <iframe frameBorder="0" src="<?php echo $lsRepUrl ?>dash/integration.php?wplogin=<?php echo $active_user['email']; ?>&url=<?php echo base64_encode($lsRepUrl); ?>" style="background-color:#ffffff; padding: 0; margin:0" width="100%" height="600" ></iframe>
                                                <br/>
                                                <a href="<?php echo $lsRepUrl ?>dash/" target="_blank">LiveSmart Dashboard</a>
                                            <?php }
                                            }
                                            ?>
                                        </div>
